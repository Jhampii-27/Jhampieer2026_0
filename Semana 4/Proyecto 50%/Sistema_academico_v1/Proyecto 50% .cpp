...
#include <iostream> //Sirve para la entrada y salida de datos por consola
#include <fstream> //Sirve para guardar y recuperar la informacion
#include <string> // Sirve para manejar cadenas de texto
#include <limits> //Ignora todo lo que el usuario haya escrito demas en el teclado
#include <ctime> // ES LA QUE VA A PONER EL TIEMPO EN EL PROGRAMA
#include <cctype> //Inspecciona y tranforma caracteres
#include <iomanip> //Da un toque mas organizado a la consola
                         ...
                         int &cantidadEstudiantes)
{
    ...
    // ============ CODIGO (5 DIGITOS, SIN DUPLICADOS) ============
    do {
        valido = true;
